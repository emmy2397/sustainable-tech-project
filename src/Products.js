    ...
    /*returns products with a price higher than 20 -> Change to a different condition like */
       return (
            <div className="product productForm" key={product.id}>
                ...
                <div>Reminder date: <br/>{(product.reminderdate) ? `Custom reminder set till ${product.reminderdate}` : "" || (product.reminder30 == "Yes") ? "30 day reminder": "" || `${product.noReminder30} reminder`}</div>
